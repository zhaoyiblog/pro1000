    ...
    <div class="modal-dialog"  >
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<%=basePath%>welfare/addWelfare" method="POST" role="form" >
                    ...
                    <div class="form-group">
                        <label for="accident_insurance">事故保险</label>
                        <select name="accident_insurance" id="accident_insurance" class="form-control">
                    ...
                    <div class="form-group">
                        <label for="medical_insurance">医药保险</label>
                    ...
                    <div class="form-group">
                        <label for="endowment_insurance">养老保险</label>
                        <select name="endowment_insurance" id="endowment_insurance" class="form-control">
                            <option value="有">有</option>
                            <option value="无">无</option>
                        </select>
                    </div>
