    ...
    <div class="row">
        ...
        <div class="col-md-10 col-md-offset-2 main" >
            ...
            <table class="table table-hover table-bordered table-responsive dataintable">
                ...
                <tbody>
                <c:forEach varStatus="status" items="${bean}" var="item">
                    <!--  var base=data.base+data.tech_year*100;
                    var class_data=data.class_number*(30+10*data.tech_year);
                    var salary=base+class_data+data.allowance;-->
                    <tr>
                        <td>${item.name}</td>
                        <td>${item.count}</td>
                    </tr>
...
<script>
    $(document).ready(function () {
        ...
        $("#btn_sel").click(function () {
            var name=$("#name").val();
            $("tbody").remove();
            $.post("<%=basePath%>/salary/getSalaryByName",
                {
                    "name":name
                },
