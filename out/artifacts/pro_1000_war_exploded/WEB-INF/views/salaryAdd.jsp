    ...
    <div class="modal-dialog"  >
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<%=basePath%>salary/salaryAdd" method="POST" role="form" >
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="base" name="base" placeholder="请输入基本工资">
                    </div>
                    <div class="form-group">
                        <label for="tech_year">教龄</label>
                        <input type="text" class="form-control" id="tech_year" name="tech_year" placeholder="">
                    </div>

                    <div class="form-group">
                        <label for="class_number">课堂数</label>
                        <input type="text" class="form-control" id="class_number" name="class_number" placeholder="">
                    </div>
                    <div class="form-group">
                        <label for="allowance">津贴</label>
                        <input type="text" class="form-control" id="allowance" name="allowance" placeholder="">
                    </div>
                ...
                function (data,status) {
                    ...
                    $.each(data,function (i,item) {
                        var s="<tr><td>"+i+"</td><td>"+
                            ...
                            item.phone+"</td><td>"+
                            "<button class='openDiag btn-primary' onclick='openModal("+item.id+",\""+item.name+"\")'>"+
                            "参数配置"+"</button></td></tr>";
