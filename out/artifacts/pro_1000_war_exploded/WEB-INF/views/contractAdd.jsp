...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-10 col-md-offset-2 main" >
            ...
            <form action="<%=basePath%>contract/contractAdd" method="POST" class="form-inline" role="form" enctype="multipart/form-data">

                <div class="form-group">
                    <label for="file">上传合同文件</label>
                    <input type="file" class="form-control" id="file" name="file" placeholder="请选择文件">
                </div>
                <div class="form-group">
                    <label for="comment">备注</label>
                    <input type="text" class="form-control" id="comment" name="comment" placeholder="请输入备注">
                </div>
                <input type="submit" class="btn btn-default" id="btn_sel" value="提交"></input>
