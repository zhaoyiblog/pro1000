...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-10 col-md-offset-2 main" >
            ...
            <form action="<%=basePath%>user/updateUser" method="POST" class="form-group" role="form">

                <div class="form-group">
                    <label for="name">姓名</label>
                    <input type="text" disabled class="form-control" id="name" name="name" value="${name}">
                </div>
                <div class="form-group">
                    <label for="password">原密码</label>
                    <input type="password" class="form-control" id="ypassword" name="ypassword" placeholder="输入原密码">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" id="confrim_password" name="confrim_password" placeholder="确认密码">
                </div>
                <input type="submit" class="btn btn-default" id="btn_sel" value="更改"></input>
...
<script>
    $(document).ready(function () {
        ...
        $("#btn_sel").click(function () {
            var name=$("#name").val();
            $("tbody").remove();
            $.post("<%=basePath%>/performance/getPerformanceByName",
                {
                    "name":name
                },
                function (data,status) {
                    ...
                    $.each(data,function (i,item) {
                        score=item.discipline_activities+item.class_adjustment+item.unInvigilate+item.unmarking+item.pass_rate+item.competition_award+item.complatint;
                        s +="<tr><td>"+item.sid+
                            "</td><td>"+item.discipline_activities+
                            "</td><td>"+item.class_adjustment+
                            "</td><td>"+item.unInvigilate+
                            "</td><td>"+item.unmarking+
                            "</td><td>"+item.pass_rate+
                            "</td><td>"+item.competition_award+
                            "</td><td>"+item.complatint+
                            "</td><td>"+score+
                            "</td></tr>";
                    });
                    s+="</tbody>";
...
<script>
    $("#confrim_password").change(function () {
